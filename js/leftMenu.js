...
var leftMenu = (function() {
    var menuList = [{
        ...
        list: [{
            url: '/manage/testSteps.html',
            name: '测试步骤列表'
        }, {
            url: '/manage/configSteps.html',
            name: '步骤配置'
        }, {
            url: '/manage/unit.html',
            name: '测试单元配置'
        }, {
            url: '/manage/configPorformanceParam.html',
            name: '性能指标参数设定'
        }, {
            url: '/manage/user.html',
            name: '用户管理'
        }, {
            url: '/manage/setCheckParam.html',
            name: '校正参数设置'
        }, {
            url: '/test/connectTest.html',
            name: '硬件连接测试'
        }]
    }];
