...
function() {
    var sendAjax = function(url, data, success, fail, type) {
        var callCode = {
            ...
            "-103": function(d) {
                alert("The operator to be added already exists and cannot be added repeatedly！");
                fail && fail(d);
            },
            "-203": function(d) {
                alert("The test unit already exists and cannot be added repeatedly！");
                fail && fail(d);
            },
            "-20": function(d) {
                alert(d.codeInfo);
    ...
    var ajax = {
         ...
         */
        enableRecord: function(setId, success, fail) {
